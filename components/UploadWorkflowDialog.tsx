          ...
          <form onSubmit={handleSubmit} className="px-6 py-4 space-y-4">
            <div className="mb-4">
              ...
              <div className="flex space-x-4">
                <label className="inline-flex items-center">
                  ...
                  />
                  <span className="ml-2 text-gray-700 dark:text-gray-300">Workflow</span>
                </label>
                <label className="inline-flex items-center">
                  <input
                    type="radio"
                  ...
                  />
                  <span className="ml-2 text-gray-700 dark:text-gray-300">Prompt</span>
                </label>
              </div>
            </div>
            ...
            <div className="mb-4">
              ...
              <div className="flex items-center space-x-2">
                {contentImage ? (
                  ...
                  <div className="w-32 h-32 bg-gray-200 dark:bg-gray-700 rounded-lg flex items-center justify-center text-gray-400 dark:text-gray-500">
            ...
            <div className="mb-4">
              ...
              <input
                ...
                required
              />
              <label htmlFor="file" className="flex items-center justify-center px-4 py-2 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 cursor-pointer">
