  ...
  return (
    <div className="p-4 max-w-2xl mx-auto">
      ...
      <div className="bg-gray-100 dark:bg-gray-800 p-4 rounded-md mb-6">
        <p className="mb-2 dark:text-gray-300">尊敬的用户，我们目前正在升级我们的在线充值系统，以提供更好的服务体验。</p>
        <p className="mb-2 dark:text-gray-300">在此期间，我们提供以下充值方式：</p>
        ...
        <p className="dark:text-gray-300">我们将尽快恢复在线充值功能，感谢您的理解和支持。</p>
      </div>
      ...
      <div className="text-center">
        ...
        {showQRCode && (
          <div className="mt-4">
            <p className="mb-2 dark:text-gray-300">请扫描下方二维码添加客服微信：</p>
            <Image
              ...
              className="mx-auto"
            />
            <p className="mt-2 dark:text-gray-300">微信号：koalababy2024</p>
          </div>
        )}
      </div>
